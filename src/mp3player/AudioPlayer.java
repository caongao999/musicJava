...
public class AudioPlayer
{
    ...
    private final ArrayList<AudioPlayerListener> _listeners = new ArrayList<AudioPlayerListener>();
    ...
    {
        for (Iterator<AudioPlayerListener> it = this._listeners.iterator(); it.hasNext();) {
            AudioPlayerListener a = it.next();
